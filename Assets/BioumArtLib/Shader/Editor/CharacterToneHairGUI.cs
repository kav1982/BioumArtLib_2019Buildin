...
public class CharacterToneHairGUI : ShaderGUI
{
    ...
    MaterialProperty subSpecColor = null;
    ...
    public void FindProperties(MaterialProperty[] props)
    {
        ...
        subSpecColor = FindProperty("_SubSpecColor", props);
    ...
    public void ShaderPropertiesGUI(Material material)
    {
        ...
        if (doubleSpecular.floatValue != 0)
        {
            ...
            m_MaterialEditor.ShaderProperty(subSpecColor, "高光颜色");
        ...
        {
            EditorGUI.indentLevel++;
            material.shader = Shader.Find("Hidden/Bioum/Character/ToneHair_Outline");
        ...
        {
            material.shader = Shader.Find("Bioum/Character/ToneHair");
        }
    }
