Shader "Bioum/Effect/Common" 
{
	...
	SubShader 
	{
		...
		Pass 
		{
			...
			#pragma target 3.5
			#pragma shader_feature_local __ ENABLE_SECONDARYTEX
			#pragma shader_feature_local __ ENABLE_DISTORT
			#pragma shader_feature_local __ ENABLE_MASK
			#pragma shader_feature_local __ ENABLE_RIM
			#pragma shader_feature_local __ ENABLE_DISSOLVE
			#pragma shader_feature_local __ ISPARTICLE
			#pragma shader_feature_local __ _ADDITIVESOFT_ON _MULTIPLY_ON _ALPHATEST_ON
